  ...
  head: () => ({
    meta: [
      ...
      { title: "Butlers & Co — Premium Hospitality Group" },
      {
        name: "description",
        content:
          "Butlers & Co is a premium hospitality group: restaurants, nightlife, catering, events and consultancy.",
      },
      { name: "author", content: "Butlers & Co" },
      { property: "og:site_name", content: "Butlers & Co" },
...
function RootComponent() {
  ...
  const isPanel = pathname.startsWith("/admin") || pathname.startsWith("/account");
